    ...
    return (
        <div className="container mx-auto p-4 flex flex-col h-screen">
            ...
            <div className="flex-1 flex flex-col items-center justify-center">
                <h2 className="text-4xl font-bold text-center">Transaction cancelled</h2>
            </div>
            ...
            {/* Note text from wireframe, usually just for context but if desired can be added as footer or small text */}
